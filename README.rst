.. image:: https://img.shields.io/badge/Release_History!--None.svg?style=social
    :target: https://github.com/MacHu-GWU/cookiecutter-aws_lbd/blob/main/release-history.rst

.. image:: https://img.shields.io/badge/STAR_Me_on_GitHub!--None.svg?style=social
    :target: https://github.com/MacHu-GWU/pywf_open_source-pyproject


``cookiecutter-aws_lbd``
==============================================================================
...
.. code-block:: bash
    ...
    pip install "cookiecutter>=2.6.0,<3.0.0" && cookiecutter https://github.com/MacHu-GWU/cookiecutter-aws_lbd

To use a specific released version (see the `full list of release at here <https://github.com/MacHu-GWU/cookiecutter-aws_lbd/releases>`_).
...
This will generate a repository structure similar to `cookiecutter_aws_lbd_demo-project <https://github.com/MacHu-GWU/cookiecutter_aws_lbd_demo-project>`_.
...
.. code-block:: bash
    ...
    cookiecutter https://github.com/MacHu-GWU/cookiecutter-aws_lbd --checkout sanhe
...
- **Seed Repository**: `cookiecutter_aws_lbd_demo-project <https://github.com/MacHu-GWU/cookiecutter_aws_lbd_demo-project>`_ - A concrete project used as the source for template generation
- **Cookiecutter Template**: `cookiecutter-aws_lbd <https://github.com/MacHu-GWU/cookiecutter-aws_lbd>`_ - This repository

**Maintenance Workflow:**

This template is maintained using a "reverse engineering" approach:

1. Make changes in the Seed project (``cookiecutter_aws_lbd_demo-project``)
