...
The :mod:`~{{ cookiecutter.package_name }}.one` subpackage is the most important
...
The :class:`~{{ cookiecutter.package_name }}.one.one_00_main.One` class is composed
from numbered mixin classes:

.. literalinclude:: ../../../../{{ cookiecutter.package_name }}/one/one_00_main.py
   :language: python
   :pyobject: One
...
:class:`~{{ cookiecutter.package_name }}.lbd.base.BaseInput`:
...
.. literalinclude:: ../../../../{{ cookiecutter.package_name }}/lbd/hello.py
   :language: python
...
handler path (e.g., ``{{ cookiecutter.package_name }}.lambda_function.hello_handler``)
always points here:

.. literalinclude:: ../../../../{{ cookiecutter.package_name }}/lambda_function.py
   :language: python
   :lines: 23-24
...
Create ``{{ cookiecutter.package_name }}/lbd/my_func.py``, following the same
pattern as :mod:`~{{ cookiecutter.package_name }}.lbd.hello`:
...
Add an import line to :mod:`~{{ cookiecutter.package_name }}.lambda_function`,
...
Add a ``lbd_func_my_func`` field to :class:`~{{ cookiecutter.package_name }}.config.config_00_main.Config`,
next to the existing fields:

.. literalinclude:: ../../../../{{ cookiecutter.package_name }}/config/config_00_main.py
   :language: python
   :lines: 32-34
...
:meth:`~{{ cookiecutter.package_name }}.one.one_01_config.OneConfigMixin.config`,
following the existing ``lbd_func_hello`` block:

.. literalinclude:: ../../../../{{ cookiecutter.package_name }}/one/one_01_config.py
   :language: python
   :lines: 39-47
...
:attr:`~{{ cookiecutter.package_name }}.config.config_00_main.Config.lbd_func_mappings`
which auto-discovers all :class:`~{{ cookiecutter.package_name }}.config.config_01_lbd_func.LbdFunc`
...
.. literalinclude:: ../../../../{{ cookiecutter.package_name }}/cdk/stacks/infra_stack.py
   :language: python
...
1. Create ``{{ cookiecutter.package_name }}/cdk/stacks/my_stack.py``.

2. Add a ``@cached_property`` to
   :class:`~{{ cookiecutter.package_name }}.cdk.stack_enum.StackEnum`, following the
   existing pattern:

   .. literalinclude:: ../../../../{{ cookiecutter.package_name }}/cdk/stack_enum.py
      :language: python
...
2. Grant the Lambda execution role permission to invoke the state machine
   ...
   :meth:`~{{ cookiecutter.package_name }}.cdk.stacks.infra_stack.InfraStack.s01_create_iam_roles`.
...
:mod:`~{{ cookiecutter.package_name }}.cdk.stacks.infra_stack_exports`.  See that
