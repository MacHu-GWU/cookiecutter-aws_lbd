...
前置条件
------------------------------------------------------------------------------
- 当 `cookiecutter_aws_lbd_demo-project <https://github.com/MacHu-GWU/cookiecutter_aws_lbd_demo-project>`_ 两个项目都趋于稳定之后再来修改此项目模板
- 由于 `cookiecutter_aws_lbd_demo-project <https://github.com/MacHu-GWU/cookiecutter_aws_lbd_demo-project>`_ 是我们的 Seed project, 而我们这个 Template 的版本是跟 Seed project 的版本保持一致的
...
1. **在 Seed 项目中进行修改**
   ...
   所有功能性的修改都应该在 Seed 项目 (``$HOME/GitHub/cookiecutter_aws_lbd_demo-project``) 中完成并测试
...
技术架构
------------------------------------------------------------------------------
- **Template Repository**: ``cookiecutter-aws_lbd`` (当前仓库)
- **Seed Repository**: ``cookiecutter_aws_lbd_demo-project``
